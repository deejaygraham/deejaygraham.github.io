...
describe('Externally linked Resources', () => {
    ...
    context('Sketchnote challenge', ()=> {
        ...
        it('Contains sketchnote image', () => {
            ...
            div.within(() => {
                ...
                img.should('have.attr', 'src', '/img/posts/sketchnoting-challenge/mac-power-users.webp');
              });
        });
    ...
    context('ACE conference', ()=> {
        it('Contains correct title', () => {
            cy.request('https://deejaygraham.github.io/img/posts/sketchnotes-from-ace-2014/gilb.png');
        });
    });
});
