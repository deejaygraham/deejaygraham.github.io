...
test("GTD Sketchnote challenge is available", async ({ page }) => {
  ...
  await page.goto('/img/posts/sketchnoting-challenge/mac-power-users-hifi.png');
});
...
test("Sketchnoting at DDD North 2015 is available", async ({ page }) => {
  ...
  await page.goto('/img/posts/sketchnoting-at-dddnorth-2015/luke-stringer.jpg');
});
...
test("ACE Conference sketchnote link is available", async ({ page }) => {
  await page.goto('/img/posts/sketchnotes-from-ace-2014/gilb.png');
});
