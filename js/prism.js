/* PrismJS 1.26.0
https://prismjs.com/download.html#themes=prism--dark&languages=markup+css+clike+javascript+aspnet+autoit+c+csharp+cpp+elixir+erlang+gherkin+git+go+go-module+java+javadoclike+jsdoc+json+json5+jsstacktrace+js-templates+powershell+processing+python+cshtml+jsx+ruby+rust+smalltalk+sql+typescript&plugins=line-numbers+custom-class+toolbar+copy-to-clipboard */
